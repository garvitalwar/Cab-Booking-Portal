...
public class booking extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        hi_name.setBounds(680, 60, 150, 29);
        ...
        jLabel4.setBounds(190, 260, 265, 30);
        ...
        jLabel6.setBounds(530, 160, 47, 29);

        jLabel7.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setText("Estimated Time");
        getContentPane().add(jLabel7);
        jLabel7.setBounds(530, 200, 163, 29);
        ...
        modify.setBounds(200, 400, 162, 40);
        ...
        jLabel9.setBounds(320, 0, 360, 90);

        jLabel5.setIcon(new javax.swing.ImageIcon("C:\\Users\\garvit soni\\Desktop\\images\\driver_blur.png")); // NOI18N
        getContentPane().add(jLabel5);
        jLabel5.setBounds(0, -70, 1430, 630);
    ...
    public void update_customer()
    {
        ...
        try 
        {
            ...
            while(rs_update_cust.next()){
                    ...
                    String user_id =rs_update_cust.getString("user_id");
                    
                    if(Long.parseLong(cust_end_time)<=curr_time)
                    { 
                        try{
                             String query="update cust set busy = ? where user_id = ?";
                             ps_update_cust=connect.prepareStatement(query);
                             ps_update_cust.setInt(1, 0);
                             ps_update_cust.setString(2, user_id);
    ...
    public class check_status extends Thread
    {
     public void run()
      {
        try{ 
               Thread.sleep(book_est_time*1000);
               
               new rideover(runame,selected_driver_uid).setVisible(true);
        } 
    ...
    private void bookActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bookActionPerformed
      ...
      String query10="select * from cust where user_id=?";
      PreparedStatement ps1=null;
        try {
