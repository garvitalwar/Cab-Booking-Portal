...
public class rides extends javax.swing.JFrame {
    ...
    void updateTable(){
        String sql="select start_pt as Pickup_Location,end_pt as Drop_Location,start_time as Date,driver as Driver_Name, status as Status from history where user_id=? order by start_time desc";
        try {
    ...
    void updateRideStatus(){
        ...
        try 
        {
            String query7 = "select * from history where user_id=? and status = \"Ongoing\"";
            ...
            while(rs_update_cust.next()){
                   ...
                   cust_end_time = rs_update_cust.getString("end_time");
                    ...
                    {   
                        ...
                        try{
                             //flag=true;
                             String query = "update history set status = \"Completed\" where user_id = ? and end_time=?";
                             ps_update_cust = connect.prepareStatement(query);
                             ps_update_cust.setString(1, user_id);
            ...
            //if(!rs_update_cust.next())
                driver_name=rs_update_cust.getString("driver");
        }catch(Exception e){
    ...
    private void initComponents() {
        ...
        jScrollPane2.setBounds(40, 90, 830, 330);
        ...
        jLabel10.setText("Book My Cab 2.0");
